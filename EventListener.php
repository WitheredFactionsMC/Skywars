...
class EventListener extends LbEventListener implements Listener {
	...
	public function onQuery(QueryRegenerateEvent $event) {
		...
		$event->setServerName('{-name-:-Lifeboat ' . $this->skywars->serverGameType . '-,-node-:{-type-:-' . $this->skywars->serverGameTypeShort . '-,-ip-:-unknown-,-players-:-' . count($this->skywars->getServer()->getOnlinePlayers()) . '-,-maxplayers-:70,-tps-:' . $this->skywars->getServer()->getTicksPerSecond() . '}}');
